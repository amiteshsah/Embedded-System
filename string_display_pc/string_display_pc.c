...
#define LCD_data_cntrl PORTB
#define en PB2		//enable lcd 1 or disable lcd 0 lcd prepare for geting data
#define rw PB1		//rw=read/write to LCD 1 for read and 0 for write
#define rs PB0		//rs=register select 0 for comm. 1 for Data
